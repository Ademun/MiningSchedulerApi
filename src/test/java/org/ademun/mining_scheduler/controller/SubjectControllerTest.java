...
public class SubjectControllerTest {
  ...
  public void create_NewSubject_ReturnsSubject() throws Exception {
    ...
    mockMvc.perform(post("/subjects").contentType(MediaType.APPLICATION_JSON).content(
            objectMapper.writeValueAsString(requestDto))).andDo(print()).andExpect(status().isCreated())
